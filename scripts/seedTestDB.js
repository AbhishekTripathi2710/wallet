...
console.log('Starting seed script for test database...');

// Connect to the test database
const DB_URL = "mongodb+srv://ronalabhishek:abhishek@authdb.kosny.mongodb.net/test?retryWrites=true&w=majority&appName=Authdb";
